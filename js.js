...
document.getElementById("ds").addEventListener("click",function(){
    calInput.innerHTML=tofixed(calInput.innerHTML*3.3,2);
    arr[4]="active";
    arr[0]=calInput.innerHTML;
    arr[2]=undefined
});
...
/*this se button event work when click Convert from NIS to Euro*/
...
/*This gs button works this when converting from pounds to shekels*/
document.getElementById("g").addEventListener("click",function(){
    calInput.innerHTML=tofixed(calInput.innerHTML/4.8,2);
    arr[4]="active";
    arr[0]=calInput.innerHTML;
    arr[2]=undefined
});
/*This sg button works this when converting from shekels to pounds*/
